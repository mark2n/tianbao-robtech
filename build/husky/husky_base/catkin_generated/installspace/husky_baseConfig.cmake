...
if(NOT "include;/usr/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'husky_base' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tudeng/tianbao-robtech/install/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>, Tony Baltovski <tbaltovski@clearpathrobotics.com>' to fix it.")
    endif()
