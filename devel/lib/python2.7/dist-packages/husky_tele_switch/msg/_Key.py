...
"""autogenerated by genpy from husky_tele_switch/Key.msg. Do not edit."""
import sys
...
bool key_pressed"""
  ...
  def serialize(self, buff):
    ...
    """
    try:
      buff.write(_struct_H.pack(self.key_code))
      _x = self.key_name
      length = len(_x)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.key_code,) = _struct_H.unpack(str[start:end])
      start = end
      end += 4
