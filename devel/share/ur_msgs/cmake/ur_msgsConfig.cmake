...
if("TRUE" STREQUAL "TRUE")
  set(ur_msgs_SOURCE_PREFIX /home/tudeng/tianbao-robtech/src/universal_robot/ur_msgs)
  set(ur_msgs_DEVEL_PREFIX /home/tudeng/tianbao-robtech/devel)
  set(ur_msgs_INSTALL_PREFIX "")
  set(ur_msgs_PREFIX ${ur_msgs_DEVEL_PREFIX})
else()
  set(ur_msgs_SOURCE_PREFIX "")
  set(ur_msgs_DEVEL_PREFIX "")
  set(ur_msgs_INSTALL_PREFIX /home/tudeng/tianbao-robtech/install)
...
if(NOT "/home/tudeng/tianbao-robtech/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ur_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tudeng/tianbao-robtech/src/universal_robot/ur_msgs/${idir}'.  Ask the maintainer 'Felix Messmer <fxm@ipa.fhg.de>, G.A. vd. Hoorn <g.a.vanderhoorn@tudelft.nl>' to fix it.")
    endif()
