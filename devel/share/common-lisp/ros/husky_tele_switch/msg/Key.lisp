...
(cl:in-package husky_tele_switch-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Key>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Key)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name husky_tele_switch-msg:<Key> is deprecated: use husky_tele_switch-msg:Key instead.")))

(cl:ensure-generic-function 'key_code-val :lambda-list '(m))
(cl:defmethod key_code-val ((m <Key>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader husky_tele_switch-msg:key_code-val is deprecated.  Use husky_tele_switch-msg:key_code instead.")
  (key_code m))

(cl:ensure-generic-function 'key_name-val :lambda-list '(m))
(cl:defmethod key_name-val ((m <Key>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader husky_tele_switch-msg:key_name-val is deprecated.  Use husky_tele_switch-msg:key_name instead.")
  (key_name m))

(cl:ensure-generic-function 'key_pressed-val :lambda-list '(m))
(cl:defmethod key_pressed-val ((m <Key>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader husky_tele_switch-msg:key_pressed-val is deprecated.  Use husky_tele_switch-msg:key_pressed instead.")
  (key_pressed m))
