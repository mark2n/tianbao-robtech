...
if("TRUE" STREQUAL "TRUE")
  set(husky_bringup_SOURCE_PREFIX /home/tudeng/tianbao-robtech/src/husky/husky_bringup)
  set(husky_bringup_DEVEL_PREFIX /home/tudeng/tianbao-robtech/devel)
  ...
  set(husky_bringup_INSTALL_PREFIX /home/tudeng/tianbao-robtech/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'husky_bringup' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tudeng/tianbao-robtech/src/husky/husky_bringup/${idir}'.  Ask the maintainer 'Paul Bovbel <paul@bovbel.com>, Tony Baltovski <tbaltovski@clearpathrobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${husky_bringup_dep}_FOUND)
      find_package(${husky_bringup_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${husky_bringup_dep} REQUIRED ${depend_list})
  endif()
